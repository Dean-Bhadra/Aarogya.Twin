  ...
  return (
    <div style={{ position: 'relative', minHeight: 'calc(100vh - 60px)' }}>
      ...
      <div className="content-wrap" style={{ position: 'relative', zIndex: 1 }}>
        <div style={{textAlign: 'center', maxWidth: '800px', margin: '60px auto 80px'}}>
          <div style={{
          ...
          <p style={{fontSize: '18px', color: 'var(--muted)', marginBottom: '40px', lineHeight: 1.6}}>
            CardioRisk AI is a secure, serverless clinical decision support system. We leverage 6 simultaneous ML models to predict physiological risk and allow real-time intervention simulations.
          </p>

          <button className="btn-primary" onClick={() => navigate('/assess')} style={{padding: '16px 40px', fontSize: '16px', borderRadius: '40px'}}>
            Begin Risk Assessment <ArrowRight size={18} />
          </button>
        </div>
        ...
        {/* Workflow Diagram */}
        <div style={{ marginBottom: '80px' }}>
          <h2 style={{fontSize: '24px', textAlign: 'center', marginBottom: '16px'}}>System Workflow Architecture</h2>
          <p style={{textAlign: 'center', color: 'var(--muted)', marginBottom: '32px'}}>How clinical data flows through the Digital Twin engine.</p>
...
// 3D Tilt Wrapper inside the same file
