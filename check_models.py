...
FILES = [
    ("CVD_Risk/cvd_health_2_model.pkl",                         "model"),
    ("Diabetes/model_diabetes_A.pkl",                           "model"),
    ("Diabetes/model_diabetes_B.pkl",                           "model"),
    ("Diabetes/diabetes_features_A.pkl",                        "features"),
    ("Diabetes/diabetes_features_B.pkl",                        "features"),
    ("Diabetes/diabetes_medians.pkl",                           "medians"),
    ("Diabetes/explainer_diabetes.pkl",                         "explainer"),
    ("Hypertension/Hypertension_risk_prediction_new_model.pkl", "model"),
    ("Obesity/lstm_model.pkl",                                  "model"),
    ("Sleep_Disorder/model_sleep.pkl",                          "model"),
    ("Sleep_Disorder/sleep_features.pkl",                       "features"),
    ("Sleep_Disorder/sleep_medians.pkl",                        "medians"),
    ("Sleep_Disorder/explainer_sleep.pkl",                      "explainer"),
    ("Stress_Risk/final_stress_model.pkl",                      "model"),
]
